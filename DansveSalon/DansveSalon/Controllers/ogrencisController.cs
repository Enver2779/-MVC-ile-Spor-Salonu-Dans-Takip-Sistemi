...
namespace DansveSalon.Controllers
{
    public class ogrencisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ono,adi,soyadi,yası,cinsiyet,boy,kilo,eposta,psw,telefon")] ogrenci ogrenci)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ono,adi,soyadi,yası,cinsiyet,boy,kilo,eposta,psw,telefon")] ogrenci ogrenci)
        {
            if (ModelState.IsValid)
            {
